...
import compact_rl.vec_storm
import os
import sys
import pickle as pkl
import re

from compact_rl.rl.environment.batched_vec_storm import BatchedVecStorm
...
storm_vec_env_constructor = StormVecEnv
...
class SimulatorInitializer:
    ...
    def load_and_store_simulator(stormpy_model = None, 
                                 ...
                                 args : ArgsEmulator = None) -> StormVecEnv | BatchedVecStorm:
