...
from compact_rl.rl.agents.networks.actor_networks import create_recurrent_actor_net_demasked
from compact_rl.rl.agents.networks.value_networks import create_recurrent_value_net_demasked
from compact_rl.rl.agents.tf_agents_modif.actor_distribution_rnn_network import ActorDistributionRnnNetwork
...
from compact_rl.rl.agents.policies.simple_fsc_policy import SimpleFSCPolicy, fsc_action_constraint_splitter
...
from compact_rl.rl.tools.encoding_methods import observation_and_action_constraint_splitter, observation_and_action_constraint_splitter_no_mask
...
class ActorValuePretrainer:
    ...
    def init_fsc_policy_driver(self, tf_environment: TFPyEnvironment, fsc: FSC = None, info_spec=None):
        ...
        """
        self.fsc = fsc
        from compact_rl.rl.agents.policies.non_tf_fsc_policy import NonTFFSCPolicy
