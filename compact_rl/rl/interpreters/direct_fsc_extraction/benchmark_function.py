...
from compact_rl.rl.interpreters.direct_fsc_extraction.test_functions import compare_two_policies, get_encoding_functions
...
def run_benchmark(prism_path: str, properties_path: str, memory_size, num_data_steps=100, num_training_steps=300,
    ...
    fsc = BlackBoxExtractor.extract_fsc(
