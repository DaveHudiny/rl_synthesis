...
def main(results_folder, shield, shield_memory, shield_path, number_of_evaluations, shield_nu, shield_model, shield_construction_agent):
    ...
    model_settings = {'dpm' : '--goal-rew 0.0', 'corridor' : '', 'drone' : ''} # USED FOR GENERATING COMMAND
    ...
    for model, agent, nu in tqdm.tqdm(eval_combinations):
        ...
        if not simulation_eval:
            ...
            add_result_to_csv(main_csv_path, model, agent, nu, shield, shield_name, avg_risk, avg_reward)
