...
def main(results_file, log_file, model_path, episode_length, num_environments,
         num_parallel_environments, agent, nu, number_of_evaluations, uniform_random_agent, model_checking_eval, goal_rew, fail_rew, deterministic_agent, shield_file_name):
