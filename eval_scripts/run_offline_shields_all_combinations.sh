...
python3 eval_shield.py --results-folder "$SUBFOLDER" --shield offline --shield-path random-nu005-mem0--eval-1-iter-final-shield.pickle --shield-model dpm --shield-construction-agent random --shield-nu 0.05 &
python3 eval_shield.py --results-folder "$SUBFOLDER" --shield offline --shield-path random-nu02-mem0--eval-1-iter-final-shield.pickle --shield-model dpm --shield-construction-agent random --shield-nu 0.2 &
wait
...
python3 eval_shield.py --results-folder "$SUBFOLDER" --shield offline --shield-path random-nu01-mem0--eval-1-iter-final-shield.pickle --shield-model corridor --shield-construction-agent random --shield-nu 0.1 &
python3 eval_shield.py --results-folder "$SUBFOLDER" --shield offline --shield-path random-nu02-mem0--eval-1-iter-final-shield.pickle --shield-model corridor --shield-construction-agent random --shield-nu 0.2 &
wait
...
python3 eval_shield.py --results-folder "$SUBFOLDER" --shield offline --shield-path random-nu005-mem0--eval-1-iter-final-shield.pickle --shield-model drone --shield-construction-agent random --shield-nu 0.05 &
python3 eval_shield.py --results-folder "$SUBFOLDER" --shield offline --shield-path random-nu02-mem0--eval-1-iter-final-shield.pickle --shield-model drone --shield-construction-agent random --shield-nu 0.2 &
wait